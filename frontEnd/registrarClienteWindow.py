...
class MainRegistrarCliente(QMainWindow):
    def __init__(self):
        super().__init__()
    ...
    def btn_registrarClick(self):
        ...
        if flagPreenchido == False:
            ...
            Usuario.cadastrar_usuario_cliente(dadosCadastrais["nome"],dadosCadastrais["email"], dadosCadastrais["senha"], dadosCadastrais["endereco"],dadosCadastrais["cidade"])
